...
<div class="navegar">
        ...
        <a href="dashboard_admin.php?operacao=clinicos" class="active"><i class="fa fa-user-md" aria-hidden="true"></i>Clínicos</a>
        <a href="dashboard_admin.php?operacao=alertas"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>Alertas</a>
