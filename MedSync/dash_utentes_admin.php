...
<p class="utentes_txt">Gestão dos utentes registados,</p>
</div>

<a href="dashboard_admin.php?operacao=registar_utente"><button class="registar"><i class="fa fa-plus-circle" aria-hidden="true"></i>Registar novo utente</button></a>
<form action="" method="post"> 
<input class="pesquisar_nr_processo" type="text" name="procurar_processo" placeholder="Processo..."/> 
...
echo '<tr class="dados_lista">
        ...
        <td class="modificar"><a href="dashboard_admin.php?operacao=editar_utente&id='.$row_usuario['id_utente'].'""><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
        <td class="excluir"><a href="dashboard_admin.php?operacao=utentes&eliminar='.$row_usuario['id_utente'].'" onclick="return confirm(\'Tem a certeza que deseja eliminar o doente selecionado?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
</tr>';
...
echo "<div>";
    ...
    echo '<tr class="dados_lista">
            ...
            <td class="excluir"><a href="dashboard_admin.php?operacao=utentes&eliminar='.$pesquisa_processos['id_utente'].'" onclick="return confirm(\'Tem a certeza que deseja eliminar o doente selecionado?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
    </tr>';
