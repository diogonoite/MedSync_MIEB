...
$query = "SELECT * FROM videos_rehab WHERE titulo NOT LIKE '%ombro%' AND titulo NOT LIKE '%cotovelo%' AND titulo NOT LIKE '%antebraço%' AND titulo NOT LIKE'%mao%' AND titulo NOT LIKE'%punho%' ORDER BY titulo ASC";
